...
class CheckUpdateTask extends AsyncTask<Void, Void, String> {
    ...
    private void parseJson(String result) {
        try {
            ...
            String updateMessage = obj.getString(Constants.APK_UPDATE_MESSAGE);
            String apkUrl = obj.getString(Constants.APK_DOWNLOAD_URL);
            boolean update_error = obj.getBoolean(Constants.APK_UPDATE_ERROR);
            Log.e("HYYYYYYYYYYYYY", Boolean.toString(update_error));
