...
public class SyncCreateNote {
    ...
    public SyncCreateNote(Context context, String topic, String note, String created_ts, String updated_ts, long user_id) {
    ...
    public void sync_new_note() {
        ...
        Call<Result> call_server = service_server.saveNote(topic, note, created_ts, updated_ts, user_id);
