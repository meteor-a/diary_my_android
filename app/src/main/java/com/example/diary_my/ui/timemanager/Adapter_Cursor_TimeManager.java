...
public abstract class Adapter_Cursor_TimeManager<ViewHolder extends RecyclerView.ViewHolder>
    ...
    public Adapter_Cursor_TimeManager(Cursor cursor) {
        super();
        ...
        idColumnIndex = cursor != null
                ? cursor.getColumnIndexOrThrow(Contact_Database.Tasks._ID)
                : -1;
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            idColumnIndex = newCursor.getColumnIndexOrThrow(Contact_Database.Tasks._ID);
            isDataValid = true;
